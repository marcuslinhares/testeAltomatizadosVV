describe('Cadastro de Professores - Sistema Externo', () => {
    it('Deve mostrar mensagem de cadastro bem sucedido ao tentar cadastrar um professor com data de nascimento valida', () => {
      ...
      cy.get('[required]').each(($el) => {
        ...
        if (elementType === 'text' || elementType === 'email' || elementType === 'tel') {
          ...
          if (placeholder === 'dd/mm/aaaa') {
            cy.wrap($el).type('01/01/1990'); // Exemplo de data valida
          } else {
